...
} from "./chunk-7F7ECO3K.js";
import {
  require_authRecipe_shared2
} from "./chunk-DUZPBKY5.js";
import {
  require_authRecipe,
                    ...
                    querier.get(
                      {
                        ...
                        queryParams: __assign(
                          ...
                          recipeImplInput.clientType !== void 0 ? { clientType: recipeImplInput.clientType } : {}
                        )
                      },
                      {},
              ...
              switch (_b.label) {
                ...
                case 2:
                  ...
                  if (jsonBody.status !== "OK") {
                    return [
                      2,
                      __assign(__assign({}, jsonBody), { fetchResponse })
                    ];
                  }
                  return [
                    2,
                ...
                case 1:
                  ...
                  return [
                    ...
                    recipe.recipeImplementation.getAuthorisationURLWithQueryParamsAndSetState(
                      __assign(__assign({ tenantId }, input), {
...
var require_thirdparty_shared = __commonJS({
  "node_modules/supertokens-auth-react/lib/build/thirdparty-shared.js"(exports) {
    ...
    var getFunctionOverrides = function(recipeId, onHandleEvent) {
      return function(originalImp) {
        return utils.__assign(utils.__assign({}, originalImp), {
          ...
          setStateAndOtherInfoToStorage: function(input) {
            var _a2;
            var loginChallenge = (_a2 = utils.getQueryParams("loginChallenge")) !== null && _a2 !== void 0 ? _a2 : void 0;
    ...
    var Provider$1 = (
      ...
      (function() {
        ...
        Provider2.prototype.getRedirectURL = function() {
          ...
          var path = superTokens.SuperTokens.getInstanceOrThrow().appInfo.websiteBasePath.appendPath(callbackPath).getAsStringDangerous();
    ...
    var ActiveDirectory = (
      /** @class */
      (function(_super) {
        utils.__extends(ActiveDirectory2, _super);
    ...
    var Apple = (
      ...
      (function(_super) {
        ...
        Apple2.prototype.getRedirectURIOnProviderDashboard = function() {
          ...
          var path = superTokens.SuperTokens.getInstanceOrThrow().appInfo.apiBasePath.appendPath(callbackPath).getAsStringDangerous();
          return "".concat(domain).concat(path);
        };
    ...
    var Bitbucket = (
      /** @class */
      (function(_super) {
        utils.__extends(Bitbucket2, _super);
    ...
    var BoxySAML = (
      /** @class */
      (function(_super) {
        utils.__extends(BoxySAML2, _super);
    ...
    var Custom = (
      /** @class */
      (function(_super) {
        utils.__extends(Custom2, _super);
        ...
        Custom2.init = function(config) {
          if (config === void 0 || config.id === void 0) {
    ...
    var Discord = (
      /** @class */
      (function(_super) {
        utils.__extends(Discord2, _super);
    ...
    var Facebook = (
      /** @class */
      (function(_super) {
        utils.__extends(Facebook2, _super);
    ...
    var Github = (
      /** @class */
      (function(_super) {
        utils.__extends(Github2, _super);
    ...
    var Gitlab = (
      /** @class */
      (function(_super) {
        utils.__extends(Gitlab2, _super);
    ...
    var Google = (
      /** @class */
      (function(_super) {
        utils.__extends(Google2, _super);
    ...
    var GoogleWorkspaces = (
      /** @class */
      (function(_super) {
        utils.__extends(GoogleWorkspaces2, _super);
    ...
    var LinkedIn = (
      /** @class */
      (function(_super) {
        utils.__extends(LinkedIn2, _super);
    ...
    var Twitter = (
      /** @class */
      (function(_super) {
        utils.__extends(Twitter2, _super);
        function Twitter2(config) {
          ...
          _this = _super.call(this, utils.__assign({ id: "twitter", name }, config)) || this;
        ...
        return utils.__generator(this, function(_a2) {
          switch (_a2.label) {
            ...
            case 1:
              ...
              tenantProviders = (loginMethods === null || loginMethods === void 0 ? void 0 : loginMethods.firstFactors.includes(types.FactorIds.THIRDPARTY)) ? loginMethods.thirdparty.providers : [];
    ...
    var ThirdParty = (
      /** @class */
      (function(_super) {
        utils.__extends(ThirdParty2, _super);
        ...
        ThirdParty2.prototype.getFirstFactorsForAuthPage = function() {
              ...
              utils.__assign(utils.__assign({}, normalisedConfig), {
                override: {
                  functions: function(originalImpl, builder) {
                    var functions = getFunctionOverrides(ThirdParty2.RECIPE_ID, normalisedConfig.onHandleEvent);
    ...
    var _a = genericComponentOverrideContext.createGenericComponentsOverrideContext(void 0, ThirdParty.RECIPE_ID);
    var useContext = _a[0];
    var Provider = _a[1];
...
//# sourceMappingURL=chunk-IBXMQ2YA.js.map
